...
<img width=800 alt="ConnectWalletMetamask" src="https://github.com/user-attachments/assets/2f602331-6773-4eec-bcee-c9674f8efb1c"> <br>

Click on the Metamask button and follow the steps to log in using web3 to access my website's content.

### Assistance
#### Unsupported Network
The Website currently supports using the Sepolia Network. You will get the page with the error message. 

<img width="800" alt="UnsupportedNetwork" src="https://github.com/user-attachments/assets/fa5496a8-2989-479e-9a07-5e4100f1235a"> 
