	...
	return (
		<div className='project-content-container'>
			<div className='project-content-container__text'>
				<ProjectText title={projectContent.title} texts={projectContent.texts}/>
				<Web3Message title={web3Message.title} defaultText={web3Message.defaultText} imageUrl={web3Message.imageUrl}/>
			</div>
